...
{   
    ...
    protected $fillable = ['start_time', 'end_time', 'totall', 'comments', 'work_type_id', 'user_id', 'monthly_id', 'date'];
    ...
    public function get_shift(){
        $user_id = Auth::id();
        $shifts = $this::where('user_id', $user_id)->where('date', 'like', '%' . $this->year . '-' . $this->month . '%')
                      ->latest()
                      ->get();
         return $shifts;
    }
